 ...
 * @date 2012-2-8
 * TODO 重写spring beans de CustomDataEditor 
 */
public class NativeCustomDataEditor extends PropertyEditorSupport {
	 ...
	 */
	public NativeCustomDataEditor(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public NativeCustomDataEditor(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
