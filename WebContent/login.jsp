	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="dologin" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="输入注册的email地址" name="email"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="输入用户密码" name="password"/>
					</div>
				</div>
			</div>
			<div class="form-actions">
				<label class="checkbox">
				<input type="checkbox" name="rememberMe" value="1"/>以后自动登录
				</label>
			...
			<div class="create-account">
				<p>
					还没有死鱼眼的账号吗？&nbsp; 
					<h3><a href="javascript:;" id="register-btn" class="">快速创建账号</a></h3>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		<!-- BEGIN FORGOT PASSWORD FORM -->
		<form class="form-vertical forget-form" action="doresetpasswd" method="post">
			<h3 class="">忘记密码了 ?</h3>
		...
		<form class="form-vertical register-form" action="doregister" method="post">
			<h3 class="">创建账户</h3>
			<p>请您填写以下信息:</p>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="controls">
					<label class="checkbox">
					<input type="checkbox" name="tnc"/> 我同意 <a href="#">服务与免责条款</a>
					</label>  
